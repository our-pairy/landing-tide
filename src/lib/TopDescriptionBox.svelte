...
<div class="grid grid-cols-12">
	<div class="col-start-4 col-span-6 text-center mt-12 animate-fade-in-bottom">
		...
		<br />
		<h1 class="font-bold text-4xl text-white">쉽게 준비하고<br />막힘없이 진행하세요.</h1>
		<br />
		<h3 class="font-light text-2xl text-white text-opacity-75 font-serif">Time to Decide, tide</h3>
		<br />
		<button
			class="transition-all duration-150 ease-out px-8 py-2 bg-cyan-600 rounded-full text-xl text-white mt-6 hover:bg-cyan-400"
